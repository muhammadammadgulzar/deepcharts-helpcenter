...
[SCREENSHOT: Absorption — What is Absorption? (DeepDOM) | dd-en-absorption-01.png]
...
[SCREENSHOT: Absorption — How to Set Up the Absorption Indicator (DeepDOM) | dd-en-absorption-02.png]
...
[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-03.png]

Examples - Max Tick - 1

[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-04.png]

Max Tick - 15

[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-05.png]
...
[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-06.png]
...
[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-07.png]

Examples - Max MS - 2050

[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-08.png]

Max MS - 10 As you can see, some of the orders have been filtered out when we added a filter of Max MS - 10

[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-09.png]
...
[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-10.png]

Examples - Min. Absorption Vol. - 20

[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-11.png]
...
[SCREENSHOT: Absorption — General Settings (DeepDOM) | dd-en-absorption-12.png]

## Plot Settings

1. Display Mode Defines how absorption is represented on the chart. You can choose between Square, Diamond and Text

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-13.png]

Text — displays absorption as a text label at the relevant price level

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-14.png]

Diamond — displays absorption as a diamond shape marker

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-15.png]

Square — displays absorption as a square shape marker

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-16.png]
...
[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-17.png]
...
[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-18.png]
...
[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-19.png]

Examples - Marker Width - 3

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-20.png]

Marker Width - 10 As you can see, when the value of Marker Width is set to 10, the size of the square is increased

[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-21.png]

## Text Settings

[SCREENSHOT: Absorption — Text Settings (DeepDOM) | dd-en-absorption-22.png]
...
[SCREENSHOT: Absorption — Plot Settings (DeepDOM) | dd-en-absorption-23.png]
