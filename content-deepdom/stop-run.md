...
[SCREENSHOT: Stop Run — overview (DeepDOM) | dd-en-stop-run-01.png]
...
[SCREENSHOT: Stop Run — What is a Stop Run? (DeepDOM) | dd-en-stop-run-02.png]
...
[SCREENSHOT: Stop Run — What to Look For During a Stop Run (DeepDOM) | dd-en-stop-run-03.png]
...
[SCREENSHOT: Stop Run — What to Look For During a Stop Run (DeepDOM) | dd-en-stop-run-04.png]
...
[SCREENSHOT: Stop Run — What to Look For During a Stop Run (DeepDOM) | dd-en-stop-run-05.png]
...
[SCREENSHOT: Stop Run — What to Look For During a Stop Run (DeepDOM) | dd-en-stop-run-06.png]
...
[SCREENSHOT: Stop Run — How to Set Up the Stop Run Indicator (DeepDOM) | dd-en-stop-run-07.png]
...
[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-08.png]
...
[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-09.png]

Min Tick - 10 As you can see, in this case every order have been filtered out when we added a filter of Min Tick - 10

[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-10.png]
...
[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-11.png]
...
[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-12.png]

Examples - Max MS - 50

[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-13.png]

Max MS - 5 As you can see, some of the orders have been filtered out when we added a filter of Max MS - 5

[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-14.png]
...
[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-15.png]

Examples - Min. Stop Run Vol. - 20

[SCREENSHOT: Stop Run — General Settings (DeepDOM) | dd-en-stop-run-16.png]
